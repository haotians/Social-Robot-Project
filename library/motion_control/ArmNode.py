...
class ArmNode(components.Components.Node):
    ...
    def __init__(self, master_object):
        ...
        self.arm_object = ArmControlClass.ArmControlClass()
        ...
        while self.thread_active:
            ...
            for i in range(len(messages)):
                if messages[i] is not None:
                    ...
                    if msg_type == 31:
                        arm_command = data[0:12]
                        head_command = data[12:15]
                    if msg_type == 92:
                        arm_data = data[1:9]
                        self.arm_object.current_angles = [0] + arm_data[0:4] + [0] + arm_data[4:8] + [0]
