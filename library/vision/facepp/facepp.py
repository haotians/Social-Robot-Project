...
class API(object):
    key = None
    secret = None
    #API_KEY = '28ea19f1334bf8262d927d88097f82f7'
    #API_SECRET = 'pYz4V4LpNL-BTFk85iR6YX4s65Bw1wh8'
    # server = 'http://apicn.faceplusplus.com/'
    server = 'http://apitest.cn.faceplusplus.com/'
